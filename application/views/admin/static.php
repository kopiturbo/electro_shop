      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="<?php echo base_url();?>kategori/tampil_kategori">Kategori</a></li>
              <li><a class="" href="<?php echo base_url();?>produk/tampil_barang">Barang</a></li>
              <li><a class="" href="<?php echo base_url();?>konsumen/tampil_konsumen">Konsumen</a></li>
            </ul>
          </li>
           <li class="sub-menu">
            <a href="javascript:;" class="">
            ...
            <ul class="sub">
              <li><a class="" href="<?php echo base_url();?>Order/tampil_order">Order</a></li>
              <li><a class="" href="<?php echo base_url();?>Detail/tampil_detail">Detail</a></li>
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
